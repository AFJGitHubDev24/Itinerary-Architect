...
4. The itinerary is generated by the AI in the form of rectangularly-arranged cards in a series fashion Each card contains the suggestions for the user with catchy headings along with the Google Maps link..
...
7. If you want to take a good look on all the locations, click on the 'View Map' button. After clicking the button, the map is generated.
...
8. If you want to download itinerary, click on 'Export' button and select the any of the following drop-down menus:
   . Save as PDF
   . Save as PPTX
   . Save as DOCX
