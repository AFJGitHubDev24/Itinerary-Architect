...
const ItineraryForm: React.FC<ItineraryFormProps> = ({ onGenerate, searchHistory, onTogglePin, onClearHistory }) => {
  ...
  const handleRequestClearHistory = () => {
    setIsHistoryOpen(false); // Close dropdown before showing modal
  ...
  return (
    <>
      ...
      <ConfirmationDialog
        ...
        message="Are you sure you want to clear all your recent searches? This will remove both pinned and unpinned items and cannot be undone."
